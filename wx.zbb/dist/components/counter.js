...
var Counter = function (_wepy$component) {
    ...
    function Counter() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Counter.__proto__ || (0, _getPrototypeOf2.default)(Counter)).call.apply(_ref, [this].concat(args))), _this), _this.props = {
            num: {
                type: [Number, String],
