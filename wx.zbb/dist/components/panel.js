...
var Panel = function (_wepy$component) {
    ...
    function Panel() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Panel.__proto__ || (0, _getPrototypeOf2.default)(Panel)).call.apply(_ref, [this].concat(args))), _this), _this.props = {
            pannelNum: {
                type: [Number, String],
        ...
        }, _this.$props = { "counter1": { "v-bind:num": "pannelNum" } }, _this.components = {
